...
multiple regression
```{r}
mult_mod <- lm(change_pls4 ~ i_group + nviq_ss + ped + word_span + age_1, data = data)
summary(mult_mod)

mult_mod2 <- lm(change_eowpvt ~ i_group + nviq_ss + ped + word_span + age_1, data = data)
summary(mult_mod2)

mult_mod3 <- lm(change_emo_total ~ i_group + nviq_ss + ped + age_1, data = data)
summary(mult_mod3)

summary(lm(change_emo_sit ~ i_group + nviq_ss + word_span + age_1, data = data))
summary(lm(change_emo_desire ~ nviq_ss + word_span, data = data))
